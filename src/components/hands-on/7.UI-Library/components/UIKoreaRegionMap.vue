...
import provinceBoundaryData from '../data/uiKoreaSido2025.json'
import { koreaRegionData, regionList } from '../js/uiRegionData'
...
<template>
  <div id="ui-korea-map" class="korea-map" aria-label="대한민국 시군구 날씨 지도"></div>
</template>
